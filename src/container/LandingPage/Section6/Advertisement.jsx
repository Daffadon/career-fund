...
const Advertisement = () => {
    return (
        <div className="flex justify-center items-center relative mb-[5em]">
            ...
            <p className={`${fontType["button"]} absolute bottom-2 sm:bottom-5 md:bottom-9 lg:bottom-12 xl:bottom-16 text-white bg-primary50 px-12 py-2 rounded-full`}>Kontak Kami</p>
        </div>
    )
}
