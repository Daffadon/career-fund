...
const UserDetailProgram = () => {
        ...
        const [showCvForm, setShowCvForm] = useState()
        const item = listCompany[0]
        return (
                <div className="flex justify-center items-center min-h-screen">
                        <div key={item.name} className="bg-white w-10/12 lg:w-7/12 xl:w-6/12 rounded-3xl px-7 py-9 flex flex-col gap-6 shadow-[5px_5px_10px_rgba(0,0,0,0.05)] ">
