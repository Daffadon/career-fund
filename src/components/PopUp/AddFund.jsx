        ...
        <div className="bg-white rounded-2xl w-[22rem] sm:w-[60rem] py-10 flex flex-col">
          ...
          <div className="flex">
            <div className="flex justify-center items-center flex-col gap-4 w-6/12">
              ...
              <p className={`${fontType['h3']} sm:text-4xl mt-10`}>{personToAdd.nama}</p>
            ...
            <div className="w-6/12 self-center">
              ...
              <CheckBox
                item={['Magang', 'Pelatihan', 'Sertifikasi']}
                checked={checkedAct}
                setChecked={setCheckedAct}
              />
            </div>
          </div>
          <button
            type="submit"
            className={`${fontType['button']} w-max self-end mr-10 bg-primary50 text-white py-3 px-24 rounded-full text-center cursor-pointer`}>
            Simpan
          </button>
        </div>
      </div>
